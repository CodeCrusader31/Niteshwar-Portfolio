...
export const metadata: Metadata = {
  title: "Niteshwar Kumar | Full Stack Developer",
  description:
    "Full Stack Engineer experienced in React, Next.js, Node.js, and scalable backend architecture. Passionate about clean code, performance, and system design",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-YRM6D9812N"
